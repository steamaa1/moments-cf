...
<style scoped>
.about-shell { max-width: 48rem; margin-inline: auto; }
...
.about-content { min-height: 180px; padding: clamp(20px, 5vw, 36px); border: 1px solid rgba(161,161,170,.18); border-radius: 20px; background: rgba(255,255,255,.78); box-shadow: 0 16px 50px rgba(24,24,27,.07); line-height: 1.8; }
