...
const env = { ...process.env, D1_DATABASE_ID: 'test-d1-id', MOMENTS_WORKER_NAME: 'test-worker', MOMENTS_D1_NAME: 'test-db', MOMENTS_R2_BUCKET: 'test-media' };
const processResult = spawn(process.execPath, ['scripts/render-build-config.mjs'], { cwd: workerDir, env });
let stderr = '';
